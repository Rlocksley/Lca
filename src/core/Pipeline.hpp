    ...
    struct Texture;
        ...
        public:
            ...
            Pipeline& addTextureArray(const uint32_t descriptorSetIndex, const uint32_t binding, const std::array<Texture, N>& textures, const VkShaderStageFlags stageFlags){
                ...
                return addTextureArrayInternal(descriptorSetIndex, binding, textures.data(), static_cast<uint32_t>(textures.size()), stageFlags);
            }
        ...
        private:
            ...
            Pipeline& addTextureArrayInternal(const uint32_t descriptorSetIndex, const uint32_t binding, const Texture* textures, uint32_t textureCount, const VkShaderStageFlags stageFlags);

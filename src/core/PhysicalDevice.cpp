...
namespace Lca
{
    namespace Core
    {
        ...
        void pickQueueFamilyIndex()
        {
            ...
            if(numberPropertiess == 0)
            {
                LCA_LOGE("pickVkPhysicalDevice", "no VkQueueFamilyPropertiess", "found")
            }
            ...
            LCA_LOGE("pickQueueFamilyIndex", "no suitable queueFamilyIndex", "found")
        }
        ...
        void pickVkPresentModeKHR()
        {
            ...
            {
                LCA_LOGE("pickVkPresentModeKHR", "no VkPresentModeKHR", "found")
            }
        ...
        VkFormat findSupportedFormat(std::vector<VkFormat>& vkFormats, const VkFormatFeatureFlags vkFormatFeatureFlags)
        {
            ...
            LCA_LOGE("findSupportedFormat", "no suitable VkFormat found", "")
        }
        ...
        void pickPhysicalDevice()
        {
            ...
            if(count == 0)
            {
                LCA_LOGE("pickPhysicalDevice", "no vkPhysicalDevices", "found")
            }
            ...
            if(!found)
            {
                LCA_LOGE("pickPhysicalDevice", "no VkPhysicalDevice fullfills requirements", "")
            }
            ...
            #ifdef LCA_DEBUG
            LCA_LOGI("PhysicalDevice", vkPhysicalDeviceProperties.deviceName, "picked")
            #endif
        }
        ...
        VkPhysicalDevice vkPhysicalDevice)
        {
            ...
            LCA_LOGE("findMemoryType", "failed to find suitable memory type", "")
        }
    }
}
...
namespace Core
{
    ...
    void checkValidationLayerSupport()
    {
        ...
        for(size_t i = 0; i < validationLayers.size(); i++)
        {
            ...
            if(!layerFound)
            {
                LCA_LOGE("checkValidationLayerSupport", "no validationLayerSupport for", validationLayers[i])
            }
        }
    }
    ...
    void createVkDebugUtilsMessenger()
    {
        ...
        if(func == NULL)
        {
            LCA_LOGE("createVkDebugUtilsMessengerEXT", "vkGetInstanceProcAddr()", "failed");
        }
        ...
        {
            LCA_LOGE("createVkDebugUtilsMessengerEXT", "vkCreateDebugUtilsMessengerEXT()", "failed");
        }
    ...
    void destroyVkDebugUtilsMessenger()
    {
        ...
        if(func == NULL)
        {
            LCA_LOGE("destroyVkDebugUtilsMessengerEXT", "vkGetInstanceProcAddr()", "failed");
        }
    ...
    void createInstance()
    {
        ...
        appInfo.pEngineName = "LCA";
        appInfo.pNext = NULL;

        VkInstanceCreateInfo createInfo;
        createInfo.sType = VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO;
        createInfo.flags = NULL;//VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR;
        ...
        LCA_LOGI("VkInstance", "created", "")
        
        createVkDebugUtilsMessenger();

        LCA_LOGI("VkDebugUtilsMessengerEXT", "created", "")

...
protected:
    void onInit() override {
        ...
        //Basic setup for Loading Screen and Game Level. Rest of Asset in GameLevel for only GameLevel.
        ...
        material.textureId = -1; // No texture for loading screen material
    ...
    void onUpdate() override {
        // Handle per-frame updates here (input, game logic, etc.)
    }
};